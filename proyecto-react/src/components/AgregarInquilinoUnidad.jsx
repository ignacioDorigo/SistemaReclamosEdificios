      ...
      <div className="card text-center">
        ...
        <div className="card-body">
          ...
          <div class="input-group flex-nowrap mb-2">
            ...
            <input type="text" class="form-control" placeholder="Codigo Edificio" aria-label="Codigo Edificio" aria-describedby="addon-wrapping" value={codigo} onChange={(e) => setCodigo(e.target.value)}/>
          </div>
          ...
          <div class="input-group flex-nowrap mb-2">
            ...
            <input type="text" class="form-control" placeholder="Documento del Inquilino" aria-label="Documento" aria-describedby="addon-wrapping" value={documento} onChange={(e) => setDocumento(e.target.value)}/>
          </div>
